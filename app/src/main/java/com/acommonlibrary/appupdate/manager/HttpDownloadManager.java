    ...
    private Runnable runnable = new Runnable() {
        ...
        public void run() {
            if (FileUtils.fileExists(downloadPath, apkName)) {
                FileUtils.deleteFile(downloadPath+File.separator+ apkName);
            }
            fullDownload();
        }
    };
    ...
    private void fullDownload() {
        ...
        try {
            ...
            if (con.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                File file = FileUtils.createFile(downloadPath, apkName);
                ...
                con.disconnect();
                MLog.d(TAG, "fullDownload: 当前地址是重定向Url，定向后的地址：" + apkUrl);
                fullDownload();
            } else {
