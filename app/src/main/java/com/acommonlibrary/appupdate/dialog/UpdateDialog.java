package com.acommonlibrary.appupdate.dialog;
...
import com.acommonlibrary.appupdate.listener.OnButtonClickListener;
...
import com.acommonlibrary.appupdate.service.DownloadService;
import com.acommonlibrary.util.AppUtils;
import com.acommonlibrary.util.DensityUtils;
import com.acommonlibrary.util.ScreenUtils;
import com.acommonlibrary.widget.NumberProgressBar;
...
//        progressBar.setVisibility(forcedUpgrade ? View.VISIBLE : View.GONE);
    ...
    private void setWindowSize(Context context) {
        ...
        lp.width = (int) (ScreenUtils.getScreenWidth() * 0.7f);
    ...
    private void installApk() {
        AppUtils.installApk(context, Constant.AUTHORITIES, apk);
    }
