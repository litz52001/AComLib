...
import static com.acomlib.util.NetworkUtils.NetworkType.*;
...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            BaseApp.getAppContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        } else {
            BaseApp.getAppContext().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) BaseApp.getAppContext()
...
//    }
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) BaseApp.getAppContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
