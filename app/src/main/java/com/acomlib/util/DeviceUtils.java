...
public class DeviceUtils {
    ...
    public static String getAndroidID() {
        return Settings.Secure.getString(BaseApp.getAppContext().getContentResolver(), Settings.Secure.ANDROID_ID);
    }
    ...
    public static void reboot(String reason) {
        PowerManager mPowerManager = (PowerManager) BaseApp.getAppContext().getSystemService(Context.POWER_SERVICE);
        try {
