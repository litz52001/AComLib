 ...
 * 默认/data/data/com.xx.terminal/files/crash/2019_07_11_08_42.txt
 * mnt/sdcard/com.xx.terminal/crash/2019_07_11_08_42.txt
 */
public class ExceptionCrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void init(Context context,String sdPath) {
        this.sdPath = sdPath;
        this.init(context);
    }
    ...
    public void init(Context context){
        ...
        if(TextUtils.isEmpty(sdPath)){
            //sdcard/PackageName/crash
            sdPath = Environment.getExternalStorageDirectory().getPath() + File.separator + mContext.getPackageName();
        }
    }
...
//            mContext.getFilesDir();//  sdcard/PackageName/crash
            String fileDir = sdPath;
            File dir = new File(fileDir + File.separator + "crash" + File.separator);
