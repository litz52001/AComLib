...
public class SecondDownLoadActivity extends AppCompatActivity {
    ...
    private TextView tvDownLoadFileName, tvDownLoadSpeed, tvDownLoadDetail,tvDownSumber;
...
//        tvDownSumber = findViewById(R.id.down_sumber);
//
//        findViewById(R.id.SecondDownLoad_pause).setOnClickListener(this);
...
//                                task.getSpeed());
//                        tvDownSumber.setText("下载进度： "+soFarBytes/1024/1024+"MB / "+totalBytes/1024/1024+"MB");
//                    }
//
//                    @Override
...
//            if (filenameTv != null) {
//                filenameTv.setText("名称 ："+task.getFilename());
//            }
//        }
//        //更新Pause时的UI（暂停）
...
//            TipUtils.showToast(String.format("下载完成！保存路径为：【%s】", task.getTargetFilePath()));
//            if (detailTv != null) {
